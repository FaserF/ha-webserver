# AI Agent Reference for ha-webserver
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/webserver_app/__init__.py` |
| Coordinator | `custom_components/webserver_app/coordinator.py` |
| Platforms | `custom_components/webserver_app/sensor.py`, `custom_components/webserver_app/button.py` |
| Config Flow | `custom_components/webserver_app/config_flow.py` |
